<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:69:"D:\phpStudy\WWW\novels\Yw\public/../application/admin\view\login.html";i:1531547927;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<div class="signinpanel">
    <div class="row">
        ...
        <div class="col-sm-5">
            <form method="post" action="index.html">
                <p class="m-t-md" id="err_msg">登录到Yw后台</p>
    ...
    <div class="signup-footer">
        <div class="pull-left">
            &copy; 2017-2019 All Rights Reserved. 王金陆
        </div>
    </div>
</div>
